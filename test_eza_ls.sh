...
run_test_substring_stderr "--format=long" "warning: unsupported option(s): --format=long" "--format=long shows warning"
run_test_substring_stderr "--dereference-command-line-symlink-to-dir" "warning: unsupported option(s): --dereference-command-line-symlink-to-dir" "--dereference-command-line-symlink-to-dir shows warning"
run_test_substring_stderr "--hide-control-chars" "warning: unsupported option(s): --hide-control-chars" "--hide-control-chars shows warning"
